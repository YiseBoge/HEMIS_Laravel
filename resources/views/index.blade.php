                ...
                <section class="showcase">
                    <div class="container-fluid p-0">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                            ...
                                            <form action="" method="get" id="staff-filter">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col form-group d-none">
                                                        ...
                                                        {!! Form::label('staff_departments', 'Department', ['class' => 'form-control-placeholder']) !!}
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                            ...
                            <a class="carousel-control-prev bg-gradient-primary" style="opacity: 0.9; width: 70px"
                               href="#carouselExampleIndicators" role="button" data-slide="prev">
                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                <span class="sr-only">Previous</span>
                            </a>
                            <a class="carousel-control-next bg-gradient-primary" style="opacity: 0.9; width: 70px"
