                                    ...
                                    <tbody>
                                        @if (count($attritions) > 0)
                                            @foreach ($attritions as $attrition)
                                                <tr role="row" class="odd" onclick="window.location='normal/{{$attrition->id}}'">
                                                    <td class="pl-4">
                                                        <div class="row">
                                                            <div class="col pt-1">
                                                                <a href="normal/{{$attrition->id}}/edit" class="text-primary mr-3"><i class="far fa-edit"></i> </a>
                                                            </div>
                                                            <div class="col">
                                                                <form class="p-0" action="/atudent-attrition/normal/{{$attrition->id}}" method="POST">
                                                                    @csrf
