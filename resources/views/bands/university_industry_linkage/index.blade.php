            ...
            <div class="card-body">
                <div class="row">
                    <div class="col p-1 m-3 text-center">
                        <a href="/band/university-linkage/create" class="btn btn-outline-primary btn-sm mb-0">
        ...
        <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModalTitle"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-content">
                    <form class="pb-5" action="/band/university-linkage" method="POST">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="editTitle">Add</h5>
                        <a href="/band/university-linkage" class="close" aria-label="Close">
