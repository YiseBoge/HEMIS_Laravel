                ...
                @if(Auth::user()->hasRole('College Super Admin'))
                    <div class="row">
                        <div class="col text-right">
                                <form action="other-region-students/0/approve" method="POST">
                                    @csrf
                ...
                @else
                    <div class="row my-3">
                        <div class="col text-right">
                            ...
                            href="/enrollment/other-region-students/create">New Entry<i
                                ...
                                <tr role="row" class="odd">
                                        ...
                                        <td class="text-center">
                                            @if($enrollment->approval_status == "Pending")
                                                <form action="other-region-students/{{$enrollment->id}}/approve" method="POST">
                                                    @csrf
                                        ...
                                        <td class="text-center">
                                            @if($enrollment->approval_status != "Approved")
                                                <div class="row px-1">
                                                    <div class="col">
                                                        <form class="p-0"
                                                            action="/enrollment/other-region-students/{{$enrollment->id}}/edit"
                                                            method="GET">
                                                            <button type="submit"
                                                    ...
                                                    <div class="col">
                                                        <form class="p-0"
                                                                action="/enrollment/other-region-students/{{$enrollment->id}}"
                                                                method="POST">
                                                            @csrf
