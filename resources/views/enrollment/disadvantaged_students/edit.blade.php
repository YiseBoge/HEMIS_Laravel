...
@section('content')
    <div class="container-fluid p-0 px-md-3">
        @if(count($errors) > 0)
            ...
            @endforeach
        @endif
        <form class="pb-5" action="/enrollment/economically-disadvantaged/{{$id}}" method="POST">
            @csrf
                ...
                <div class="col">
                    <fieldset class="card shadow h-100">
                        <div class="card-header text-primary">
                            Edit Economically Disadvantaged Students Enrollment Information
                        ...
                        <div class="card-body px-4">
                            <div class="form-group row pt-3">
                                <div class="col form-group">
                                    <label class="label" for="quintile">Quintile</label>
