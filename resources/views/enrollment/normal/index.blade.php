                                        ...
                                        @if(Auth::user()->hasRole('College Super Admin'))
                                            <th style="min-width: 50px; width: 50px">
                                                <form action="normal/0/approve" method="POST">
                                                    ...
                                                    <input type="hidden" name="student_type" value="{{$selected_student_type}}">
                                                    <input type="hidden" name="program" value="{{$selected_program}}">
                                                    <input type="hidden" name="education_level" value="{{$selected_education_level}}">
                                                    <button type="submit" class="form-control btn btn-sm btn-link text-primary text-lg p-1">
                                                            <u>Approve All</u>
                                                    </button>                                                    
                                                </form>
                                            </th>
                                        ...
                                        @if (count($enrollments) > 0)
                                            @foreach ($enrollments as $enrollment)
                                                <tr role="row" class="odd" onclick="window.location='normal/{{$enrollment->id}}'">
                                                    @if(Auth::user()->hasRole('College Super Admin'))
                                                    <td>
                                                        <form action="normal/{{$enrollment->id}}/approve" method="POST">
                                                            @csrf
                                                            @if($enrollment->approval_status == "Approved")
                                                                <input type="hidden" name="action" value="disapprove">
                                                                <button type="submit" class="form-control btn btn-sm btn-link text-danger p-0">
                                                                        <u>Disapprove</u>
                                                                </button>
                                                            @else 
                                                                <input type="hidden" name="action" value="approve">
                                                                <button type="submit" class="form-control btn btn-sm btn-link text-primary p-0">
                                                                        <u>Approve</u>
                                                                </button>
                                                            @endif
