                    ...
                    <div class="row">
                        <div class="col text-right">
                            <form action="age-enrollment/0/approve" method="POST">
                                ...
                                <button type="submit"
                                        class="btn btn-sm btn-primary shadow-sm" {{count($enrollment_info) == 0 ? 'disabled' : ''}}>
                        ...
                        @if (count($enrollment_info) > 0)
                            @foreach ($enrollment_info as $info)
                                <tr role="row" class="odd">
                                    ...
                                    @else
                                        <td class="text-center">
                                            @if(!in_array($info->approval_status, ["Approved", "College Approved"]))
                                                <div class="row px-1">
                                                    <div class="col px-0">
                                                        <form class="p-0"
                                    ...
                                    <td>{{$info->female_students_number + $info->male_students_number}}</td>
                                   @if($info->approval_status == "Approved")
                                    ...
                                    @elseif($info->approval_status == "Pending")
                                        <td class="text-warning"><i
                                                    class="far fa-clock"></i></i> {{$info->approval_status}}</td>
                                    @else
                                        <td class="text-danger"><i class="fas fa-times"></i> {{$info->approval_status}}
                                        </td>
                                    @endif
                                </tr>
                            @endforeach
