                    ...
                    <fieldset class="card shadow mt-md-0 mt-5 h-100">
                        ...
                        <div class="form-row mt-2 pt-3">
                            <div class="col form-group">
                                <div class="col">
                                <div class="form-group">                                    
                                    <input class="form-control" id="employment_date" name="date_of_employment" type="date" placeholder="2011-08-19">
                                    <label for="employment_date" class="form-control-placeholder">Employment Date</label>
                                </div>
                                </div> 
                            </div> 
                            ...
                            <div class="col-md form-group">
                                 <div class="col">
                                <div class="form-group">                                    
                                    <input class="form-control" id="contract_start" name="start_of_contract" type="date" placeholder="2011-08-19">
                                    <label for="contract_start" class="form-control-placeholder">Start of Contract</label>
                                </div>
        
                            <div class="col-md form-group">
                                 <div class="col">
                                <div class="form-group">                                    
                                    <input class="form-control" id="contract_end" name="end_of_contract" type="date" placeholder="2011-08-19">
