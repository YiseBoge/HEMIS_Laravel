                    ...
                    <fieldset class="card shadow mt-md-0 mt-5 h-100">
                        ...
                        <div class="card-body px-5">
                            <div class="form-row pt-3">
                                ...
                                <div class="col-md form-group">
                                    <input type="text" id="specializn" name="specialization" class="form-control"
                                           required>
                            ...
                            <div class="form-row mt-2 pt-3">
                                ...
                                <div class="col-md form-group">
                                    <div class="col">
                                        <div class="form-group">
                                            <input class="form-control" id="contract_start" name="start_of_contract"
                                                   type="date"
                                        ...
                                        <div class="col-md form-group">
                                            <div class="col">
                                                <div class="form-group">
                                                    <input class="form-control" id="contract_end" name="end_of_contract"
                                                           type="date"
                                                           placeholder="2011-08-19">
                                                    <label for="contract_end" class="form-control-placeholder">End of
                                                        contract</label>
                                                </div>
                                            </div>
                                        </div>
