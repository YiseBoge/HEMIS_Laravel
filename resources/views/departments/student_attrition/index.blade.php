        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                @if(Auth::user()->hasRole('College Super Admin'))
                    <div class="row">
                        <div class="col text-right">
                            <form action="student-attrition/0/approve" method="POST">
                                @csrf
                ...
                @else
                    <div class="row my-3">
                        <div class="col text-right">
                            <a class="btn btn-primary btn-sm mb-0 shadow-sm" href="/student/student-attrition/create">New
                                Entry<i
                        ...
                        @if (count($attritions) > 0)
                            @foreach ($attritions as $attrition)
                                <tr role="row" class="odd">
                                    @if(Auth::user()->hasRole('College Super Admin'))
                                        <td class="text-center">
                                            @if($attrition->approval_status == "Pending")
                                                <form action="student-attrition/{{$attrition->id}}/approve"
                                                      method="POST">
                                                    @csrf
                                    ...
                                    <td>{{$attrition->female_students_number + $attrition->male_students_number}}</td>
