                    ...
                    <div class="row my-3">
                        <div class="col text-right">
                            <form action="diaspora-courses/0/approve" method="POST">
                                ...
                                <button type="submit"
                                        class="btn btn-sm btn-primary shadow-sm" {{count($courses) == 0 ? 'disabled' : ''}}>
                                ...
                                <tr role="row" class="odd"
                                    ...
                                    <td class="text-center">
                                        @if(Auth::user()->hasRole('College Super Admin'))
                                            ...
                                            @endif
                                        @else
                                            @if(!in_array($course->approval_status, ["Approved", "College Approved"]))
                                                <div class="row px-1">
                                                    <div class="col px-0">
                                                        <form class="p-0"
                                    ...
                                    <td>{{$course->female_number + $course->male_number}}</td>
