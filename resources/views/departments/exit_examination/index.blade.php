                    ...
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            <div class="row">
                                <div class="col text-right">
                                    <a class="btn btn-outline-primary btn-sm mb-0" href="exit-examination/create">New Entry<i
                                    ...
                                    <tbody>
                                        @if (count($examinations) > 0)
                                            @foreach ($examinations as $examination)
                                                <tr role="row" class="odd" onclick="window.location='/student/exit-examination/{{$examination->id}}'">
                                                    <td class="pl-4">
                                                        <div class="row">
                                                            <div class="col pt-1">
                                                                <a href="normal/{{$examination->id}}/edit" class="text-primary mr-3"><i class="far fa-edit"></i> </a>
                                                            </div>
                                                            <div class="col">
                                                                <form class="p-0" action="/student/exit-examination/{{$examination->id}}" method="POST">
                                                                    @csrf
