                                ...
                                <div class="card-body px-4">
                                    ...
                                    <div class="form-row pt-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <label class="form-control-placeholder" for="receipt_number">Receipt Number</label>
                                    ...
                                    <div class="form-row pt-3">
                                            <div class="col-md-6 form-group">                                        
                                                <input class="form-control" id="registration_date" name="registration_date" type="date" placeholder="2011-08-19">
                                            ...
                                            <div class="col-md-6 form-group">                                        
                                                <input class="form-control" id="clearance_date" name="clearance_date" type="date" placeholder="2011-08-19">
            ...
            <fieldset class="card shadow h-100 my-5">
                ...
                <div class="card-body px-4">
                    <div class="form-row pt-3">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="number" id="food_expenses" name="food_expenses" class="form-control" required>
                                <label class="form-control-placeholder" for="food_expenses">Food Expenses</label>                                
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="number" id="dormitory_expenses" name="dormitory_expenses" class="form-control" required>
                                <label class="form-control-placeholder" for="dormitory_expenses">Dormitory Expenses</label>                                
                            </div>
                        </div>
                    </div>
                    <div class="form-row pt-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="number" id="pre_payment_amount" name="pre_payment_amount" class="form-control" required>
                                <label class="form-control-placeholder" for="pre_payment_amount">Pre-Payment Amount</label>                                
                            </div>
                        </div>
                        
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="number" id="unpaid_amount" name="unpaid_amount" class="form-control" required>
                                <label class="form-control-placeholder" for="unpaid_amount">Total Unpaid Cost Sharing Amount</label>                                
                            </div>
                        </div>
                    </div>
                </div>
