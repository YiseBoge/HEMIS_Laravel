                    ...
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            <div class="row">
                                <div class="col text-right">
                                    <a class="btn btn-outline-primary btn-sm mb-0" href="teachers/create">New Entry<i
                                    ...
                                    <tbody>
                                        @if (count($teachers) > 0)
                                            @foreach ($teachers as $teacher)
                                                <tr role="row" class="odd" onclick="window.location='teachers/{{$teacher->id}}'">
                                                    <td class="pl-4">
                                                        <div class="row">
                                                            <div class="col pt-1">
                                                                <a href="teachers/{{$teacher->id}}/edit" class="text-primary mr-3"><i class="far fa-edit"></i> </a>
                                                            </div>
                                                            <div class="col">
                                                                <form class="p-0" action="/department/teachers/{{$teacher->id}}" method="POST">
                                                                    @csrf
