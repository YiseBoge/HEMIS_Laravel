            ...
            <div class="card-body">
                <div class="row my-3">
                    <div class="col text-right">
                        <a class="btn btn-primary btn-sm mb-0 shadow-sm" href="/department/expatriate-staff/create">New
                            Entry<i
                    ...
                    <div class="form-row">
                        <div class="col-md-5 px-3 py-md-1 col">
                            <div class="form-group">
                                {!! Form::select('rank_level', \App\Models\Department\ExpatriateStaff::getEnum('StaffRanks') , $data['selected_level'] , ['class' => 'form-control', 'id' => 'add_rank_level', 'onchange' => 'this.form.submit()']) !!}
