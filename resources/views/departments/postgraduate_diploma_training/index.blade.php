                    ...
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            <div class="row">
                                <div class="col text-right">
                                    <a class="btn btn-outline-primary btn-sm mb-0" href="postgraduate-diploma-training/create">New Entry<i
                                    ...
                                    <tbody>
                                        @if (count($trainings) > 0)
                                            @foreach ($trainings as $training)
                                                <tr role="row" class="odd" onclick="window.location='postgraduate-diploma-training/{{$training->id}}'">
                                                    <td class="pl-4">
                                                        <div class="row">
                                                            <div class="col pt-1">
                                                                <a href="postgraduate-diploma-training/{{$training->id}}/edit" class="text-primary mr-3"><i class="far fa-edit"></i> </a>
                                                            </div>
                                                            <div class="col">
                                                                <form class="p-0" action="/department/postgraduate-diploma-training/{{$training->id}}" method="POST">
                                                                    @csrf
