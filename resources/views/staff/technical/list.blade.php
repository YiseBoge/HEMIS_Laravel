                                    ...
                                    <tbody>
                                        @if (count($staffs) > 0)
                                          @foreach ($staffs as $staff)
                                              <tr role="row" class="odd" onclick="window.location='administrative/{{$staff->id}}'">
                                                  <td class="pl-4">
                                                      <div class="row">
                                                          <div class="col pt-1">
                                                              <a href="administrative/{{$staff->id}}/edit" class="text-primary mr-3"><i class="far fa-edit"></i> </a>
                                                          </div>
                                                          <div class="col">
                                                              <form class="p-0" action="/staff/administrative/{{$staff->id}}" method="POST">
                                                                  @csrf
