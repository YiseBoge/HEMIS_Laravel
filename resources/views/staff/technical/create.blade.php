        ...
        <form class="pb-5" action="/staff/technical" method="POST">
                    ...
                    <fieldset class="card shadow mt-md-0 mt-5 h-100">
                        ...
                        <div class="form-row pt-3">
                            ...
                            <div class="col-md form-group">
                                ...
                                <select class="form-control" id="academic-level" name="academic_level" data-live-search="true">
            ...
            <fieldset id="academic-staff" class="card shadow">
                ...
                <div class="card-body px-5"> 
                    <div class="form-row pt-3">                    
                        <div class="col form-group">
                                <select class="form-control" id="aca-staff-rank" name="technical_staff_rank">
                                    @foreach ($staff_ranks as $key => $value)
                                        <option value="{{$key}}">{{$value}}</option>
                                    @endforeach
                                </select>
                                <label for="aca-staff-rank" class="form-control-placeholder">Technical Staff Rank</label> 
                        </div> 
                    </div>                               
                    <div class="form-row pt-3">
                        <div class="col form-group">                       
