            ...
            <div class="card-body">
                <form action="/publication/{{$publications_and_patents->id}}" method="POST">
                    ...
                    <div class="container row mt-3 px-5">
                        <div class="col-md-8">
                            <div class="text-sm font-weight-bold text-uppercase mb-1">Number of Publications By Postgraduate Students</div>
                            <div class="input-group mb-3"> 
                                <div class="input-group-prepend">
                                    <span class="input-group-text bg-white border-0"><i class="text-gray-400 float-right far fa-edit "></i></span>
                                </div>                                      
                                <input type="text" class="form-control form-control-plaintext" name="student_publications" value="{{$publications_and_patents->student_publications}}">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-3"> 
                                ...
                                <input type="text" class="form-control form-control-plaintext" name="patents" value="{{$publications_and_patents->patents}}">
                ...
                <div class="table-responsive mt-5">
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        <div class="text-sm font-weight-bold text-uppercase mb-1">Publications By Academic Staff with Rank of Associate and Full Professor</div>
                        <hr>
                        <div class="row">
                                    ...
                                    <tbody>
                                      @if (count($publications) > 0)
                                        @foreach ($publications as $publication)
                                            <tr role="row" class="odd" onclick="window.location='publication/{{$publication->id}}'">
                                                <td class="pl-4">
                                                    <div class="row">
                                                        <div class="col pt-1">
                                                            <a href="publication/{{$publication->id}}/edit" class="text-primary mr-3"><i class="far fa-edit"></i> </a>
                                                        </div>
                                                        <div class="col">
                                                            <form class="p-0" action="/publication/{{$publication->id}}" method="POST">
                                                                @csrf
