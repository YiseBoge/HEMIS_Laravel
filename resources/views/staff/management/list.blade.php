            ...
            <div class="card-body">
                <div class="row my-3">
                    <div class="col text-right">
                        <a class="btn btn-primary btn-sm mb-0 shadow-sm" href="/staff/management/create">New Entry<i
                        ...
                        @if (count($staffs) > 0)
                            @foreach ($staffs as $staff)
                                <tr role="row" class="odd"
                                    onclick="window.location='management/{{$staff->id}}'">
                                    <td class="pl-4">
                                        <div class="row">
                                            <div class="col pt-1">
                                                <a href="management/{{$staff->id}}/edit"
                                                   class="text-primary mr-3"><i class="far fa-edit"></i>
                                                </a>
                                            </div>
                                            <div class="col">
                                                <form class="p-0" action="/staff/management/{{$staff->id}}"
                                                      method="POST">
                                                    @csrf
