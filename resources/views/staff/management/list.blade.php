    ...
    <div class="container-fluid">
        <div class="card shadow-sm mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Management Staff</h6>
            </div>
            <div class="card-body">
                    ...
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        <div class="row">
                            <div class="col text-right">
                                <a class="btn btn-outline-primary btn-sm mb-0" href="management/create">Add Staff<i
                                    ...
                                    <tbody>
                                      @if (count($staffs) > 0)
                                        @foreach ($staffs as $staff)
                                            <tr role="row" class="odd" onclick="window.location='management/{{$staff->id}}'">
                                                <td class="pl-4">
                                                    <div class="row">
                                                        <div class="col pt-1">
                                                            <a href="management/{{$staff->id}}/edit" class="text-primary mr-3"><i class="far fa-edit"></i> </a>
                                                        </div>
                                                        <div class="col">
                                                            <form class="p-0" action="/staff/management/{{$staff->id}}" method="POST">
                                                                @csrf
