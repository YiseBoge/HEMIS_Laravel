                    ...
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        <div class="row">
                            <div class="col text-right">
                                <a class="btn btn-outline-primary btn-sm mb-0" href="ict/create">Add Staff<i
                                        ...
                                        @foreach ($staffs as $staff)
                                            <tr role="row" class="odd" onclick="window.location='ict/{{$staff->id}}'">
                                                <td class="pl-4">
                                                    <div class="row">
                                                        <div class="col pt-1">
                                                            <a href="ict/{{$staff->id}}/edit" class="text-primary mr-3"><i class="far fa-edit"></i> </a>
                                                        </div>
                                                        <div class="col">
                                                            <form class="p-0" action="/staff/ict/{{$staff->id}}" method="POST">
                                                                @csrf
