...
@section('content')
    <div class="container mb-5">
        ...
        <div class="row mt-4"> 
            <div class="col-md-3">
                <div class="text-sm font-weight-bold text-gray-900 text-uppercase mb-1">ICT STaff Category</div>
                <p>Business Application Administration & Development</p>
            </div>                      
            <div class="col-md-3">
                <div class="text-sm font-weight-bold text-gray-900 text-uppercase mb-1">ICT STaff Type</div>
                <p>Junior Application/Software Developer</p>
            </div>
        </div>   
