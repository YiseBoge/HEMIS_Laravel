                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group mb-3"> 
                            ...
                            <input type="text" class="form-control form-control-plaintext" name="nationality" value="{{$student->nationality}}">
                        </div> 
                    </div> 
                    <div class="col-md-3">
                        ...
                        <div class="input-group mb-3"> 
                            ...
                            <input type="text" class="form-control form-control-plaintext" name="years_in_ethiopia" value="{{$student->years_in_ethiopia}}">
                        </div> 
                    </div>   
                </div>
            </div>
