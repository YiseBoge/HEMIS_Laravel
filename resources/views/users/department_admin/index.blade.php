    ...
    <div class="container-fluid p-0 px-md-3">
        <div class="card shadow mt-3">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Department Admin</h6>
            </div>
            <div class="card-body">
                <div class="row my-3">
                    <div class="col text-right">
                        <a class="btn btn-primary btn-sm mb-0 mx-2 shadow-sm" href="/department-admin/generate">Auto
                            Generate<i
                                    class="fas fa-magic text-white-50 fa-sm ml-2"></i></a>
                        <a class="btn btn-primary btn-sm mb-0 shadow-sm" href="/department-admin/create">New Entry<i
