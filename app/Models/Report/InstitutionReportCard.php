...
class InstitutionReportCard extends Model
{
    ...
    protected $enumKpis = [
        ...
        '1.2.2' => 'Increase in the share of STEM subjects from master programs',
        '1.2.3' => 'Increase in the share of STEM subjects from doctoral studies',

        '1.3.1' => 'Increase in the percentage of females in undergraduate programs',
        '1.3.2' => 'Increase in the percentage of females in master programs',
        '1.3.3' => 'Increase in the percentage of females in doctoral studies',
        '1.3.4' => 'Increase in the percentage of females in health specialty programs',

        '1.4.1' => 'Increase in the percentage of females undergraduate in STEM subjects',
        '1.4.2' => 'Increase in the percentage of females in STEM master programs',
        '1.4.3' => 'Increase in the percentage of females in STEM doctoral studies',

        '1.5.1' => 'Increase in the percentage of students with disabilities in undergraduate programs',
        '1.5.2' => 'Increase in the percentage of students with disabilities in master programs',
        '1.5.3' => 'Increase in the percentage of students with disabilities in doctoral studies',
        '1.5.4' => 'Increase in the percentage of students with disabilities in health specialty programs',

        '1.6.1' => 'Increase in the percentage of students from emerging regions in undergraduate programs',
        '1.6.2' => 'Increase in the percentage of students from emerging regions in master programs',
        '1.6.3' => 'Increase in the percentage of students from emerging regions in doctoral studies',
        '1.6.4' => 'Increase in the percentage of students from emerging regions in health specialty programs',

        '1.7.1' => 'Increase in the percentage of students from economically poorhouse holds in undergraduate programs',
        '1.7.2' => 'Increase in the percentage of students from economically poor households in master programs',
